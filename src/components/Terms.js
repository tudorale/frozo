...
import Navigation from './subComponents/NavigationTwo';
    ...
    return (
        <>
            ...
            <div className="terms">
                ...
                <li>
                <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Frozo.</p>
                </li>
                <li>
                ...
                <p>In special TeeSpring who is the company that will handle your payment and delivery.</p>
